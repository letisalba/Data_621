...
#model_lin_train[c(24, 41, 58, 63, 178, 194, 213, 224, 238, 244, 264),]
...
# Create new data set with outliers removed
dftrain2 <- model_lin_train[c(-2, -5, -9, -25, -49, -62, -77, -103, -110, -136, -210),]
...
lmcv <- train(formula(lm_mod9), data=dftrain2, method="lm", trControl=tc)
print(lmcv)
summary(lmcv)
