...
2. The adjusted R-squared value is a modified R-squared that adjusts according to the number of predictors in a model. This value will increase as the model improves and 
