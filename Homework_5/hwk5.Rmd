...
Now we'll impute missing values using R's Mulitple Imputation by Chained Equations (MICE) package. We'll avoid imputing the STARS variable as the absence of a star rating may be a significant predictor.
...
Note: this should be the final plot before we start model building section:
---------------
