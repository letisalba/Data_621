...
We are choosing model 6 after evaluating all the models in the section Model Building. The adjusted $R^2$ is better than the other models.
...
```{r}
#write.csv(eval_df_final, "predictions.csv", row.names = F)
```
